      ...
      <div class="info_more">
        <ul class="contacts-list">
          ...
          <a href="tel:{{phone}}" class="contact-item">
            <div class="icon-box"><ion-icon name="phone-portrait-outline" role="img" aria-label="phone portrait outline"></ion-icon></div>
            <div class="contact-info">
          ...
          <li class="contact-item">
            <div class="icon-box"><ion-icon name="location-outline" role="img" aria-label="location outline"></ion-icon></div>
            <div class="contact-info">
